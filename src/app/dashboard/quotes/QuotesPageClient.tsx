...
type QuotesPageClientProps = {
  ...
  initialData?: QuotesDashboardResponse
}
...
export function QuotesPageClient({ initialData }: QuotesPageClientProps) {
  ...
  const [result, setResult] = useState<PaginatedResult<SeedQuote> | null>(initialData?.result ?? null)
  const [summary, setSummary] = useState<QuoteSummary | null>(initialData?.summary ?? null)
