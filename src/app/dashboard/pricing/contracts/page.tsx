  ...
  return (
    <>
      ...
      <main className="flex-1 overflow-auto p-4 md:p-6 space-y-6">
        ...
        <Card className="shadow-sm">
          <CardHeader><CardTitle className="flex items-center gap-2"><FileText className="h-4 w-4" /> Contracts</CardTitle></CardHeader>
          <CardContent>
            {error && (
                  ...
                  <TableBody>
                    {contracts.map((contract) => (
                      <TableRow key={contract.id}>
                        ...
                        <TableCell className="text-sm">{contract.expiration_date ?? '-'}</TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
